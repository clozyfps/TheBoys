...
import net.mcreator.theboys.procedures.WebWeaverSkillBarDisplayOverlayIngameProcedure;
...
public class WebWeaverSkillBarOverlay {
	...
	public static void eventHandler(RenderGuiEvent.Pre event) {
		...
		if (WebWeaverSkillBarDisplayOverlayIngameProcedure.execute(entity)) {
			event.getGuiGraphics().blit(new ResourceLocation("the_boys:textures/screens/ability_bar_webweaver.png"), 5, h - 31, 0, 0, 97, 25, 97, 25);

			if (SelectedMove1DisplayProcedure.execute(entity)) {
				event.getGuiGraphics().blit(new ResourceLocation("the_boys:textures/screens/ability_selected.png"), 4, h - 32, 0, 0, 26, 26, 26, 26);
			}
			if (SelectedMove2DisplayProcedure.execute(entity)) {
				event.getGuiGraphics().blit(new ResourceLocation("the_boys:textures/screens/ability_selected.png"), 23, h - 32, 0, 0, 26, 26, 26, 26);
			}
			if (SelectedMove3DisplayProcedure.execute(entity)) {
				event.getGuiGraphics().blit(new ResourceLocation("the_boys:textures/screens/ability_selected.png"), 40, h - 32, 0, 0, 26, 26, 26, 26);
			}
