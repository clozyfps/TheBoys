package net.mcreator.theboys.client.model;
...
public class Modelafterimage<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("the_boys", "modelafterimage"), "main");
	...
	public Modelafterimage(ModelPart root) {
