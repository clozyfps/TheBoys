...
import net.mcreator.theboys.procedures.OutputOnKeyPressedProcedure;
...
public class OutputMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		TheBoysMod.addNetworkMessage(OutputMessage.class, OutputMessage::buffer, OutputMessage::new, OutputMessage::handler);
	}
}
