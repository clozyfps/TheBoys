...
import net.mcreator.theboys.procedures.TalentOnKeyReleasedProcedure;
import net.mcreator.theboys.procedures.TalentOnKeyPressedProcedure;
...
public class TalentMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		TheBoysMod.addNetworkMessage(TalentMessage.class, TalentMessage::buffer, TalentMessage::new, TalentMessage::handler);
	}
}
