...
import net.mcreator.theboys.procedures.SwitchCurrentMoveProcedure;
...
public class SwitchMoveMessage {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			SwitchCurrentMoveProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		TheBoysMod.addNetworkMessage(SwitchMoveMessage.class, SwitchMoveMessage::buffer, SwitchMoveMessage::new, SwitchMoveMessage::handler);
	}
}
